...
bot.on("message", function(message) {
    ...
    if((message.channel.type === "dm") && message.content.includes("feedback"))
    {
        ...
        collector.on('collect', fbMessage => {
            if (fbMessage.content.toLowerCase().includes('yes'))
            {
                message.channel.send("Wonderful!");
                feedbackGate = true;
            }
            else if (fbMessage.content.toLowerCase().includes('no'))
            {
        ...
        //{
            ...
            collector.next.then(anonMessage => {
                ...
                {
                    message.channel.send("Then your secret is safe with me!");
                }
                else if (anonMessage.content.toLowerCase().includes('no'))
                {
